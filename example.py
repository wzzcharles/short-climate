...
if __name__ == '__main__':
     ...
     file = 'E:/Work/Python/short_climate/exp1/hgt.mon.mean.nc'  #读取数据
     DataSet=['hgt','lat','lon','level']    
     hgt,lat,lon,level = GetVar((file),DataSet)
     
     Jan_500_mean = np.mean(hgt[(32*12):(62*12)+1:12,2,:,:],axis=0)      #1980年1月500hPa平均
     hgt_an= hgt[62*12,2,:,:]-Jan_500_mean                             #1980年1月500hPa距平
    ...
    #lon, lat = np.meshgrid(lon, lat) #生成网格点
     ...
     #plt.colorbar(shrink=1,or ientation = 'horizontal')#设置色标，使色标横向
     #plt.show() #展示图片
     plt.savefig('E:/Work/Python/short_climate/exp1/Jan_500_mean.png') #保存图片
     ...
     plt.savefig('E:/Work/Python/short_climate/exp1/Jan_500_coluur.png') #保存图片
